...
our %config = (
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/home/zehn/luckfox-pico/tools/linux/toolchain/arm-rockchip830-linux-uclibcgnueabihf/bin/arm-rockchip830-linux-uclibcgnueabihf-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  openssldir => "",
  options => "enable-shared --prefix=/home/zehn/luckfox_pico_rtsp_yolov5/client_sdk/openssl-1.1.1v/install --cross-compile-prefix=/home/zehn/luckfox-pico/tools/linux/toolchain/arm-rockchip830-linux-uclibcgnueabihf/bin/arm-rockchip830-linux-uclibcgnueabihf- no-afalgeng no-asan no-asm no-async no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.34.0",
  perlargv => [ "linux-x86_64", "no-asm", "shared", "no-async", "--prefix=/home/zehn/luckfox_pico_rtsp_yolov5/client_sdk/openssl-1.1.1v/install", "--cross-compile-prefix=/home/zehn/luckfox-pico/tools/linux/toolchain/arm-rockchip830-linux-uclibcgnueabihf/bin/arm-rockchip830-linux-uclibcgnueabihf-" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/zehn/luckfox_pico_rtsp_yolov5/client_sdk/openssl-1.1.1v/install",
  processor => "",
